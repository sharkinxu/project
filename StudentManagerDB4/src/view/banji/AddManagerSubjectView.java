...
public class AddManagerSubjectView {
	...
	JButton sureButton1;
	CallBack callBack;
	private static AddManagerSubjectView instance;

	private AddManagerSubjectView(CallBack callBack) {
	...
	public static AddManagerSubjectView getInstance(CallBack callBack) {
		if (instance == null) {

			instance = new AddManagerSubjectView(callBack);
